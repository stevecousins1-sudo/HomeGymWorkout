export const MOVEMENTS = [
  ...
  { name: 'Incline cable fly',     category: 'Chest',     equipment: 'Cable machine' },
  { name: 'Cable decline fly',     category: 'Chest',     equipment: 'Cable machine' },
  { name: 'Single arm cable fly',  category: 'Chest',     equipment: 'Cable machine' },
  { name: 'Cable crossover',       category: 'Chest',     equipment: 'Cable machine' },
  ...
  { name: 'Single arm lat pulldown', category: 'Back',   equipment: 'Cable machine' },
  { name: 'Reverse grip pulldown', category: 'Back',      equipment: 'Cable machine' },
  { name: 'High cable row',        category: 'Back',      equipment: 'Cable machine' },
  { name: 'Kneeling cable pulldown', category: 'Back',   equipment: 'Cable machine' },
  ...
  { name: 'Cable front raise',     category: 'Shoulders', equipment: 'Cable machine' },
  { name: 'Cable rear delt fly',   category: 'Shoulders', equipment: 'Cable machine' },
  { name: 'Cable Y raise',         category: 'Shoulders', equipment: 'Cable machine' },
  { name: 'Cable internal rotation', category: 'Shoulders', equipment: 'Cable machine' },
  ...
  { name: 'Cable hammer curl',     category: 'Arms',      equipment: 'Cable machine' },
  { name: 'Cable preacher curl',   category: 'Arms',      equipment: 'Cable machine' },
  { name: 'Low cable curl',        category: 'Arms',      equipment: 'Cable machine' },
  { name: 'Cross body curl',       category: 'Arms',      equipment: 'Dumbbell' },
  { name: 'Tricep pushdown',       category: 'Arms',      equipment: 'Cable machine' },
  { name: 'Single arm tricep pushdown', category: 'Arms', equipment: 'Cable machine' },
  { name: 'Cable skull crusher',   category: 'Arms',      equipment: 'Cable machine' },
  ...
  { name: 'Cable Romanian deadlift', category: 'Legs',   equipment: 'Cable machine' },
  { name: 'Cable squat',           category: 'Legs',      equipment: 'Cable machine' },
  { name: 'Cable lunge',           category: 'Legs',      equipment: 'Cable machine' },
  { name: 'Cable hip abduction',   category: 'Legs',      equipment: 'Cable machine' },
  { name: 'Cable hip adduction',   category: 'Legs',      equipment: 'Cable machine' },
  { name: 'Cable glute kickback',  category: 'Legs',      equipment: 'Cable machine' },
  { name: 'Cable standing calf raise', category: 'Legs', equipment: 'Cable machine' },
  ...
  { name: 'Kneeling cable crunch', category: 'Core',      equipment: 'Cable machine' },
  { name: 'Pallof press',          category: 'Core',      equipment: 'Cable machine' },
  { name: 'Cable woodchop',        category: 'Core',      equipment: 'Cable machine' },
  { name: 'Cable low to high',     category: 'Core',      equipment: 'Cable machine' },
  { name: 'Cable side bend',       category: 'Core',      equipment: 'Cable machine' },
